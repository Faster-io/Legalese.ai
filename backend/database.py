...
if not DATABASE_URL:
    ...
    # 0. Strip whitespace (Crucial for copy-paste errors)
    ...
    # 2. Aggressively remove query parameters (like prepared_statement)
    # This prevents 'invalid connection option' errors from Prisma-style URLs
    if "?" in DATABASE_URL:
